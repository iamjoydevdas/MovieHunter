package com.moviehunter.handlers;

import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;

import com.moviehunter.exception.MovieHunterException;
import com.moviehunter.model.ServiceResponse;
import com.moviehunter.model.ServiceResponse.Errors;
...
public class ResponseHandlers<T> {
	...
	public <R> ResponseEntity<ServiceResponse<R>> handleExceptions(MovieHunterException ex) {
		ServiceResponse<T> responseModel = (ServiceResponse<T>) ServiceResponse.builder()
				.success(false)
				.error(
						Errors.builder()
